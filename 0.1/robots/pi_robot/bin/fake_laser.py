...
class fake_laser():
    ...
    def __init__(self):
        ...
        self.fixed_reading = rospy.get_param("~fixed_reading", 3.0)
        ...
        rospy.loginfo("Started fake laser node publishing to /base_scan topic.")
        ...
        while not rospy.is_shutdown():
            ...
            for i in range(self.num_readings):
                ranges.append(self.fixed_reading)
