/* Auto-generated by genmsg_cpp for file /home/patrick/Eclipse/ros/pi-robot-ros-pkg/pi_sandbox/demo_tracker/msg/Skeleton.msg */
#ifndef DEMO_TRACKER_MESSAGE_SKELETON_H
#define DEMO_TRACKER_MESSAGE_SKELETON_H
#include <string>
#include <vector>
#include <ostream>
...
private:
  static const char* __s_getDataType_() { return "demo_tracker/Skeleton"; }
public:
...
public:
  ...
  typedef boost::shared_ptr< ::demo_tracker::Skeleton_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::demo_tracker::Skeleton_<ContainerAllocator>  const> ConstPtr;
}; // struct Skeleton
typedef  ::demo_tracker::Skeleton_<std::allocator<void> > Skeleton;

typedef boost::shared_ptr< ::demo_tracker::Skeleton> SkeletonPtr;
typedef boost::shared_ptr< ::demo_tracker::Skeleton const> SkeletonConstPtr;


template<typename ContainerAllocator>
std::ostream& operator<<(std::ostream& s, const  ::demo_tracker::Skeleton_<ContainerAllocator> & v)
{
  ros::message_operations::Printer< ::demo_tracker::Skeleton_<ContainerAllocator> >::stream(s, "", v);
  return s;}
...
{
template<class ContainerAllocator>
struct MD5Sum< ::demo_tracker::Skeleton_<ContainerAllocator> > {
  static const char* value() 
  {
    return "34722af981b6a61700ff31df5a97c2e0";
  }

  static const char* value(const  ::demo_tracker::Skeleton_<ContainerAllocator> &) { return value(); } 
  static const uint64_t static_value1 = 0x34722af981b6a617ULL;
  static const uint64_t static_value2 = 0x00ff31df5a97c2e0ULL;
};

template<class ContainerAllocator>
struct DataType< ::demo_tracker::Skeleton_<ContainerAllocator> > {
  static const char* value() 
  {
    return "demo_tracker/Skeleton";
  }
...
template<class ContainerAllocator>
struct Definition< ::demo_tracker::Skeleton_<ContainerAllocator> > {
  static const char* value() 
  {
...
template<class ContainerAllocator> struct HasHeader< ::demo_tracker::Skeleton_<ContainerAllocator> > : public TrueType {};
template<class ContainerAllocator> struct HasHeader< const ::demo_tracker::Skeleton_<ContainerAllocator> > : public TrueType {};
} // namespace message_traits
} // namespace ros
...
template<class ContainerAllocator> struct Serializer< ::demo_tracker::Skeleton_<ContainerAllocator> >
{
...
template<class ContainerAllocator>
struct Printer< ::demo_tracker::Skeleton_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const  ::demo_tracker::Skeleton_<ContainerAllocator> & v) 
  {
    s << indent << "header: ";
s << std::endl;
...
#endif // DEMO_TRACKER_MESSAGE_SKELETON_H
