...
namespace skeleton_tracker
{
  class SkeletonTracker
  {
    ...
    void publishTransform(KinectController &kinect_controller, XnUserID const &user, XnSkeletonJoint const &joint, std::string const &frame_id, std::string const &child_frame_id, pi_tracker::Skeleton &skeleton)
      {
